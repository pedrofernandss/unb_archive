...
@router.post(
    "/procedures/gerenciar-validacao", 
    status_code=status.HTTP_204_NO_CONTENT,
    summary="Executa a lógica de validação de um material por um docente"
)
def executar_validacao_material(request_data: ValidacaoMaterialRequest):
    ...
    try:
        ...
        # Procedures geralmente não retornam dados, então um status 204 é apropriado.
        return
    except Exception as e:
        # Captura exceções levantadas pela procedure (ex: 'Docente não encontrado')
        # e as transforma em um erro HTTP claro.
        raise HTTPException(
